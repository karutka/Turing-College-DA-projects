...
WITH customer_info AS (
            SELECT 
                ...
                LEFT(AddressLine1, STRPOS(AddressLine1, ' ') -1 ) AS address_no,
                RIGHT(AddressLine1, LENGTH(AddressLine1) - STRPOS(AddressLine1, ' ')) AS Address_st,
        ...
        info AS (
            SELECT 
                ...
                customer_info.address_no AS address_no,
                customer_info.Address_st AS Assress_st,
...
WHERE activity = 'Active' 
    AND Country IN ('United States', 'Cananda')
